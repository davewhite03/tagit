...
import AudioPlayer from './ItemPlatform/Music/AudioPlayer';

const CreatePin = ({ user }) => {
  
  const [audioAsset, setAudioAsset] = useState(null);
  const [wrongAudioType, setWrongAudioType] = useState()
            ...
            {!audioAsset ? (
              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32 text-gray-400">
                    Recommendation: Use high-quality MP3
                  </p>
                </div>
                <input
                  type="file"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          {user && (
           ...
           <input
            ...
            placeholder="What is your quiz question?"
          ...
          />
           <input
            ...
            placeholder="What is your quiz answer?"
            className="outline-none text-base sm:text-lg border-b-2 border-gray-200 p-2"
          />
          <input
            type="text"
